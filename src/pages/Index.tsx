...
Мы, гр. ${contractData.fullName},
паспорт: серия ${contractData.passportSeries}, N ${contractData.passportNumber}, выдан ___________________________,
проживающий(ая) по адресу: _________________________________________________,
именуем__ в дальнейшем "Займодавец", и гр. _________________________________,
паспорт: серия ________, N __________, выдан ______________________________,
проживающий(ая) по адресу: _________________________________________________,
именуем__ в дальнейшем "Заемщик", заключили настоящий договор о
нижеследующем:

    1. Займодавец передает Заемщику в собственность
________________________________________________________________________________
...
не позднее "${contractData.contractDate}" г.
...
настоящего договора, он обязан уплатить Займодавцу неустойку (пени) в размере ___% от
...
________________________________________________________________________________
                    ...
                    РЕКВИЗИТЫ ЗАИМОДАВЦА (ООО ЭКОРРА ФИНАНСОВЫЙ ЦЕНТР)
...
Дата возврата займа:          ______________________________

________________________________________________________________________________

Заемщик подтверждает получение суммы займа в размере ${loanAmount.toLocaleString('ru-RU')} рублей
и обязуется вернуть указанную сумму с процентами в установленный срок.
